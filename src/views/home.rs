...
pub fn Home() -> Element {
    rsx! {
        ...
        p {
            "I'm deeply invested in Linux and open source. I build my workflow around Niri, WezTerm, Fish, and Neovim. I'm particularly interested in Rust for its emphasis on correctness and explicitness (which led me to building this site as a full-stack Dioxus project)."
        }
        p {
