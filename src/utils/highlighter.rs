...
impl SyntaxHighlighterAdapter for CustomHighlighter {
    fn write_highlighted(
        ...
        if let Some(fname) = filename {
            ...
            write!(
                output,
                "<div class=\"tui-footer\"><span class=\"tui-sec-a\">NORMAL</span><span class=\"tui-sec-b\">{} {}</span><span class=\"tui-sec-c\">{}</span><span class=\"tui-sec-x\">utf-8</span><span class=\"tui-sec-y\">{}</span><span class=\"tui-sec-z\">Top</span></div>",
                branch_icon,
                branch,
                fname,
